            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Remove Farmer</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        if (isset($_GET["alert"])) {
            if ($_GET["alert"] == "execute" || $_GET["alert"] == "sql" || $_GET["alert"] == "fields") {
                ...
                echo ('<div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Success !</strong> Farmer removed from system.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="container text-center">
                    <h2 style="color: rgb(64, 187, 64);">Remove Farmer</h2>
                </div>
                <br>
                <form method="POST" action="../includes/removeFarmerBack.php">
                    <div class="row mx-5 px-5">
                        <div class="col-sm-6 d-flex justify-content-center mt-1">
                            <label for="farmerID">Farmer ID</label>
                        </div>
                        <div class="col-sm-6 pr-5">
                            <input type="text" class="form-control" name="farmerID" id="farmerID">
                        </div>
                    </div>
                    <div class="row d-flex mt-3 justify-content-center">
                        <button type="submit" class="btn" style="background-color: #00cc83;border-color: #00cc83; color:white;">Remove Farmer</button>
                    </div>
                </form>
                <br>
            </div>
