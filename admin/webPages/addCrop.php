    ...
    <section class="content">
        <div class="container-fluid">
            <div class="container text-center">
                <h2 style="color: rgb(64, 187, 64);">Add Crop</h2>
            </div>
            <br>
            <form method="GET" action="../includes/addCropBack.php">
                ...
                <div class="row d-flex mt-3 justify-content-center">
                    <button type="submit" class="btn" style="background-color: #00cc83;border-color: #00cc83; color:white;">Add Crop</button>
                </div>
            </form>
            <br>
        </div>
